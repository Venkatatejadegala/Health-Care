...
class GeminiService {
    constructor() {
        Object.defineProperty(this, "model", {
            ...
            configurable: true,
            writable: true,
            value: genAI.getGenerativeModel({ model: 'gemini-2.0-flash-exp' })
        });
        Object.defineProperty(this, "visionModel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: genAI.getGenerativeModel({ model: 'gemini-2.0-flash-exp' })
     ...
     */
    async analyzeFoodFromImage(imageFile) {
        try {
     ...
     */
    async getMockRecommendations(userProfile) {
        // Simulate API delay
     ...
     */
    async getFoodNutritionInfo(foodName) {
        try {
            const prompt = `
     ...
     */
    async askAboutFoodAndHealth(question, userProfile) {
        try {
